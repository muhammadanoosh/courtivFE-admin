            ...
            <div className="navbar-wrapper">
                <div className="m-header">
                    <Link href="/" className="b-brand">
                        ...
                        <Image width={140} height={30} src="/images/logo-Blue.png" alt="logo" className="logo logo-lg" />
                    ...
                    <PerfectScrollbar>
                        ...
                        <div className="card text-center">
                            <div className="card-body">
                                ...
                                <p className="fs-11 my-3 text-dark">Courtiv is a production ready CRM to get started up and running easily.</p>
